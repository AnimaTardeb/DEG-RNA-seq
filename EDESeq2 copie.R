...
write.table(respadjfc,file="/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAmRNA-results.txt",sep="\t",quote=F)
write.table(counts(dds, normalized=TRUE), file="/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAmRNA-normalized.txt", sep="\t")
...
#respadjfc <- res[ order(res$padj, decreasing = FALSE), ]
#data2<-counts(dds, normalized=TRUE)
outputfile3="/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAmRNAcountsResults.txt"
outputfile2="/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAMergedCountsmRNAgenename.csv"
outputfile1="/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BACountsmRNAgenename.csv"
...
#_________________________________________________
png("/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAmRNADispersions.png", width = 7*300, height = 5*300, res = 400, pointsize = 12)
plotDispEsts(dds)
dev.off()
#_________________________________________________
#plot pval
png("/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAmRNA_pval.png", width = 7*300, height = 5*300, res = 400, pointsize = 12)
hist(res$pvalue,breaks=100,col="grey", xlab="p-value",main="p-value distribution")
dev.off()

########################################
name=read.table("/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAMergedCountsmRNAgenename.csv", header=T,sep=";",row.names = 1)

#miRNA

#another type of maplot
png("/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAmRNA_MAggplot.png", width = 7*300, height = 5*300, res = 400, pointsize = 12)
...
name=read.table("/Volumes/AMINABE/tt/results/mRNA/Figures/Filter5-12samples/BA/MergedCountsmRNAgenename.csv", header=T,sep=";",row.names = 1)

png("/Volumes/AMINABE/tt/results/mRNA/Figures/Filter5-12samples/BA/BAmRNA_volcanoggplot.png", width = 7*400, height = 5*300, res = 400, pointsize = 12)
...
png("/Volumes/AMINABE/tt/results/mRNA/Figures/withoutfilter/new/BA/BAVolcanoplot_mRNA.png",  width = 10*300, height = 7*300, res = 400, pointsize = 8)
